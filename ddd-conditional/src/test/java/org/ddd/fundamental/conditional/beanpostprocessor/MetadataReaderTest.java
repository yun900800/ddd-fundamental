...
public class MetadataReaderTest {
    ...
    @Test
    public void testMetadataReader () throws IOException {
        SimpleMetadataReaderFactory readerFactory = new SimpleMetadataReaderFactory();
        // 获取 MetadataReader
        MetadataReader metadataReader = readerFactory.getMetadataReader("org.ddd.fundamental.conditional.beanpostprocessor.metadatareader.MyBean");
        ...
        // 获取方法上的注解信息
        for (MethodMetadata methodMetadata : metadataReader.getAnnotationMetadata().getAnnotatedMethods("org.ddd.fundamental.conditional.beanpostprocessor.metadatareader.MyAnnotation")) {
