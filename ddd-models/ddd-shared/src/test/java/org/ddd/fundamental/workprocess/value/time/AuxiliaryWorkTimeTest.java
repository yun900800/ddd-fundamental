...
public class AuxiliaryWorkTimeTest {
    ...
    public void testCreateAuxiliaryWorkTime() {
        ...
        DateRange checkTimeRange = new DateRange(
                DateTimeUtils.strToDate("2024-10-01 16:59:12","yyyy-MM-dd HH:mm:ss"),
                DateTimeUtils.strToDate("2024-10-01 18:59:12","yyyy-MM-dd HH:mm:ss"),"工序检查时间");
        AuxiliaryWorkTime auxiliaryWorkTime = AuxiliaryWorkTime.create(setTimeRange,offlineTimeRange,checkTimeRange);
    ...
    public void testChange(){
        ...
        auxiliaryWorkTime = auxiliaryWorkTime.changeSetTime(DateTimeUtils.strToDate("2024-11-04 16:30:12","yyyy-MM-dd HH:mm:ss"));
        System.out.println(auxiliaryWorkTime.getSetTime().minutes());
        auxiliaryWorkTime = auxiliaryWorkTime.changeCheckTime(
                new DateRange(
                        DateTimeUtils.strToDate("2024-11-04 16:30:13","yyyy-MM-dd HH:mm:ss"),
                        DateTimeUtils.strToDate("2024-11-04 16:55:12","yyyy-MM-dd HH:mm:ss"),"工序下线时间")
        );
        System.out.println(auxiliaryWorkTime.getCheckTime().minutes());
        auxiliaryWorkTime = auxiliaryWorkTime.changeOffLineTime(
                new DateRange(
                        DateTimeUtils.strToDate("2024-11-04 16:56:13","yyyy-MM-dd HH:mm:ss"),
                        DateTimeUtils.strToDate("2024-11-04 18:55:12","yyyy-MM-dd HH:mm:ss"),"工序检查时间")
        );
