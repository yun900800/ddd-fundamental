...
public class EquipmentMasterTest {
    ...
    public void testCreateEquipmentMaster() {
        EquipmentMaster equipmentMaster = EquipmentMaster.newBuilder()
                ...
                .build();
        Assert.assertEquals("EquipmentMaster{assetNo='asset2085', equipmentName='飞利浦车床', size=EquipmentSize{width=2.5, length=3.6, height=2.0}, standard=MaintainStandard{maintainRule='需要人工维护', workTime=Sat Oct 12 00:00:00 CST 2024}, personInfo=PersonInfo{personCount=2, qualification='车床资质证书'}, qualityInfo=QualityInfo{checkStatus='验证未通过', checkPlan='需要三方检测计划', checkResult=false}}",
