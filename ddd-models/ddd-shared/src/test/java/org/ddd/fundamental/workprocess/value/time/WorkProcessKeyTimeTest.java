...
public class WorkProcessKeyTimeTest {
    ...
    public void createWorkProcessKeyTime() {
        WorkProcessKeyTime workProcessKeyTime = WorkProcessKeyTime.start(Instant.parse("2024-11-10T10:34:56.789Z"));
    ...
    public void testChangeEndTime() {
        ...
        WorkProcessKeyTime workProcessKeyTime1 = WorkProcessKeyTime.start(Instant.parse("2024-11-12T10:34:56.789Z"));
