...
import org.ddd.fundamental.datasource.provider.query.PostgresSQLQueries;
...
public class PostgreSQLDataSourceProvider extends AbstractContainerDataSourceProvider implements DataSourceProvider {
    ...
    public Queries queries() {
        return PostgresSQLQueries.INSTANCE;
    }
}
